...
import com.hq.financial.support.WafRequestWrapper;
...
public class HttpKit {
     ...
     */
    public static String sendGet(String url, Map<String, String> paramters){
        String result = "";
        ...
        try{
            ...
            String urlString = url + "?"+ query.toString();
