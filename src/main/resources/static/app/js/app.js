 ...
 * should be included in all pages. It controls some layout.html
...
$.AdminLTE.options = {
  ...
  //Activate sidebar slimscroll if the fixed layout.html is set (requires SlimScroll Plugin)
  sidebarSlimScroll: true,
  //Enable sidebar expand on hover effect for sidebar mini
  //This option is forced to true if both the fixed layout.html and sidebar mini
  //are used together
...
$(function () {
  ...
  //Activate the layout.html maker
...
function _init() {
  ...
  /* Layout
   * ======
   * Fixes the layout.html height in case min-height fails.
   *
   * @type Object
   * @usage $.AdminLTE.layout.html.activate()
   *        $.AdminLTE.layout.html.fix()
   *        $.AdminLTE.layout.html.fixSidebar()
   */
  $.AdminLTE.layout = {
    activate: function () {
      var _this = this;
    ...
    fixSidebar: function () {
      ...
      if (!$("body").hasClass("fixed")) {
        ...
        window.console.error("Error: the fixed layout.html requires the slimscroll plugin!");
      }
      //Enable slimscroll for fixed layout.html
      ...
      .on('click', menu + ' li a', function (e) {
        ...
        if ((checkElement.is('.treeview-menu')) && (checkElement.is(':visible')) && (!$('body').hasClass('sidebar-collapse'))) {
          ...
          checkElement.slideUp(animationSpeed, function () {
            ...
            //Fix the layout.html in case the sidebar stretches over the height of the window
            //_this.layout.html.fix();
          });
  ...
  $.AdminLTE.controlSidebar = {
    ...
    activate: function () {
      ...
      //If the body has a boxed layout.html, fix the sidebar bg position
      var bg = $(".control-sidebar-bg");
      _this._fix(bg);

      //If the body has a fixed layout.html, make the control sidebar fixed
      if ($('body').hasClass('fixed')) {
...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      // + "<input type='checkbox' data-layout.html='fixed' class='pull-right'/> "
      // + "固定布局"
      // + "</label>"
      ...
      // + "<div class='form-group'>"
      // + "<label class='control-sidebar-subheading'>"
      // + "<input type='checkbox' data-layout.html='layout.html-boxed'class='pull-right'/> "
      // + "装箱布局"
      // + "</label>"
      // + "<p>激活装箱布局</p>"
      // + "</div>"
      ...
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      + "<input type='checkbox' data-layout.html='sidebar-collapse' class='pull-right'/> "
      + "切换侧边栏"
      + "</label>"
      + "<p>左侧边栏是否展开</p>"
      + "</div>"
  ...
  /**
   * Toggles layout.html classes
   *
   * @param String cls the layout.html class to toggle
   * @returns void
   */
  function change_layout(cls) {
    $("body").toggleClass(cls);
    AdminLTE.layout.fixSidebar();
    //Fix the problem with right sidebar and layout.html boxed
    if (cls == "layout.html-boxed")
  ...
  function setup() {
    ...
    //Add the layout.html manager
    $("[data-layout.html]").on('click', function () {
    ...
    $("[data-enable='expandOnHover']").on('click', function () {
      ...
      AdminLTE.pushMenu.expandOnHover();
      if (!$('body').hasClass('sidebar-collapse'))
        $("[data-layout.html='sidebar-collapse']").click();
    });

    // Reset options
    if ($('body').hasClass('fixed')) {
      $("[data-layout.html='fixed']").attr('checked', 'checked');
    }
    if ($('body').hasClass('layout-boxed')) {
      $("[data-layout.html='layout.html-boxed']").attr('checked', 'checked');
    }
    if ($('body').hasClass('sidebar-collapse')) {
      $("[data-layout.html='sidebar-collapse']").attr('checked', 'checked');
    }
